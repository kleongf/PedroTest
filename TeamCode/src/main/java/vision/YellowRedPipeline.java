...
public class YellowRedPipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        java.util.List<MatOfPoint> redContours = new java.util.ArrayList<>();
        java.util.List<MatOfPoint> yellowContours = new java.util.ArrayList<>();
        Mat hierarchy = new Mat();

        Imgproc.findContours(redROI, redContours, hierarchy, Imgproc.RETR_EXTERNAL, Imgproc.CHAIN_APPROX_SIMPLE);
