...
public class RedSpecimenPush extends OpMode {
    ...
    private final Pose startPose = new Pose(134, 72, Math.toRadians(0));
    ...
    /** Pick up blocks */
    private final Pose pickup1Pose = new Pose(86, 120, Math.toRadians(180));

    private final Pose pickup2Pose = new Pose(86, 130, Math.toRadians(180));

    private final Pose pickup3Pose = new Pose(86, 137, Math.toRadians(180));

    // once blocks are picked up they need to be placed in the taped off area

    private final Pose placePickup1Pose = new Pose(120, 120, Math.toRadians(180));

    private final Pose placePickup2Pose = new Pose(120, 130, Math.toRadians(180));

    private final Pose placePickup3Pose = new Pose(120, 137, Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        grabPickup1 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(scorePose),
                                new Point(140, 102, Point.CARTESIAN),
                                new Point(105, 98, Point.CARTESIAN),
                                new Point(83, 113, Point.CARTESIAN),
        ...
        grabPickup2 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(placePickup1Pose),
                                new Point(86, 116, Point.CARTESIAN),
        ...
        grabPickup3 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(placePickup2Pose),
                                new Point(86, 124, Point.CARTESIAN),
        ...
        goToPickupZone = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(placePickup3Pose),
                                new Point(120, 116, Point.CARTESIAN),
