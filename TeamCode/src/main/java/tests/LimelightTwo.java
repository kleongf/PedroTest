    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive()) {
            ...
            if (result != null) {
                ...
                double centerX = (pythonOutput[1]+pythonOutput[3] / 2);
                double deltaX = centerX - 160;
                double angleX = (deltaX / 160) * 27;
                double centerY = (pythonOutput[2]+pythonOutput[4] / 2);
                double deltaY = centerY - 120;
                double angleY = (deltaY / 120) * 20.5;
